class Question {
  ...
  display(){
    ...
    this.question.html("Pergunta:- dentre os 4 seres mais poderosos de Devil's Truths, qual parece mais perigo?" );
    // question.html("Pergunta:- O que é que está no meio do começo, no começo do meio, e no final do fim? " );

    this.question.position(150, 80);
    this.option1.html("1: O anjo da loucura" );
    this.option1.position(150, 100);
    this.option2.html("2: A luxúria encarnada" );
    this.option2.position(150, 120);
    this.option3.html("3: O dragão da ira" );
    this.option3.position(150, 140);
    this.option4.html("4: O semi deus neutro" );
